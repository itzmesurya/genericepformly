(function () {
    ...
    function fillJsonData() {
        ...
        $http.get('main/config.json').then(function (response) {
    ...
    mainApp.config(function ($routeProvider) {
        ...
        $routeProvider.when('/genericFormlydemo', {
            templateUrl: 'demo/generic-formly.html',
            controller: 'GenericFormlyController as gfc'
        });
    ...
    mainApp.config(function (formlyConfigProvider) {
        ...
        /**
         * Template that switches between multiple templates within itself 
         * Eg: switching between ACE and Material Lab
         */
        ...
        // formlyConfigProvider.templateManipulators.postWrapper.push(function (template, options, scope) {
        //     if (!options.data.somePropertyToTriggerTheManipulator) {
        //         return template;
        //     }

        //     return template + '<awesome-template-button></awesome-template-button>';
        // });
        ...
        formlyConfigProvider.setWrapper({
            name: 'dumbText',
            template: '<b>wrapper1 starts</b><formly-transclude></formly-transclude><b>wrapper1 ends</b>'
        });
        formlyConfigProvider.setWrapper({
            name: 'dumbText2',
            template: '<i>wrapper2 starts</i><formly-transclude></formly-transclude><i>wrapper2 ends</i>'
        });

        formlyConfigProvider.setType({
            name: 'md-input',
            wrapper: ['dumbText', 'dumbText2'],
